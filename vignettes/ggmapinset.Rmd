...
## Example usage
This example uses the mosquito surveillance dataset [`mozzies_nsw2301`]. It
includes points from across New South Wales.
...
This looks a little congested. We can improve things a bit by using the repulsive
version of the label geom from `{ggrepel}`:
